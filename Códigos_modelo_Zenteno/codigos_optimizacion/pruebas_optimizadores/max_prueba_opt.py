"""
max_prueba_opt.py
- Script de prueba para optimización de parámetros usando métodos evolutivos y metaheurísticos.
- Incluye funciones para preparar la estructura del modelo, construir parámetros completos, 
convertir entre diccionarios y vectores de parámetros, simular el sistema, 
calcular el objetivo con desglose de errores, imprimir el desglose en cada iteración, 
y ejecutar los métodos de optimización: Differential Evolution, Dual Annealing, 
PSO manual y PSO usando MealPy.
"""
