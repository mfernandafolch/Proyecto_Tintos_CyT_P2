"""
main2_opt.py
Código de prueba para optimización. Permite elegir entre varios métodos de optimización global.
- DE (differential evolution)
- DA (dual annealing)
- PSO (particle swarm optimization)
Requiere tener las librerías correspondientes instaladas para cada método.
Nota: Para PSO se recomienda usar el archivo main2_opt_pso.py, que tiene varias implementaciones de PSO.
"""
