"""
main2_opt_pso.py
Código de prueba para optimización con PSO. Permite elegir entre varias implementaciones de PSO.
- PSO personalizado (pso_custom)
- PSO con PySwarms (pso_pyswarms)
- PSO con MealPy (pso_mealpy)
- PSO con Pymoo (pso_pymoo)
Requiere tener las librerías correspondientes instaladas para cada método.
"""
