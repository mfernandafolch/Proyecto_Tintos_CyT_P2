"""
prueba_opt.py
Funciones para optimización de parámetros con distintos métodos globales y refinamiento local.
Incluye:
- Preparación de modelos con parámetros fijos y libres.
- Función objetivo con desglose de errores.
- Wrappers para DE, DA, PSO (scipy y MEALPY) y least_squares.
