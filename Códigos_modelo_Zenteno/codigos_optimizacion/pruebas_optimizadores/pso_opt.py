"""
pso_opt.py
Implementación de optimización por PSO para estimar parámetros de un modelo de fermentación.
Incluye:
- Función objetivo basada en la simulación del sistema y comparación con datos experimentales.
- Implementación de PSO personalizada.
- Integración con bibliotecas externas: pyswarms, mealpy y pymoo.
- Manejo de parámetros fijos y libres, con límites definidos.
- Funciones de utilidad para preparar modelos, construir parámetros completos y calcular desgloses de objetivos.
"""
