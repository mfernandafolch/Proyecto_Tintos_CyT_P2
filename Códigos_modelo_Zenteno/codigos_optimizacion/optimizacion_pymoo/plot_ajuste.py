"""
plot_ajuste.py
Gráficos de ajuste para sets puntuales de parámetros.

Descripción:
Este script permite visualizar el ajuste entre las simulaciones del modelo y los datos experimentales para un
conjunto específico de parámetros (sin optimización). Se pueden seleccionar uno o varios datasets para comparar
los perfiles de azúcares y el etanol final. El costo gráfico se calcula como
la suma de los errores cuadráticos normalizados para azúcares y etanol, proporcionando una métrica cuantitativa
del ajuste. 
"""
