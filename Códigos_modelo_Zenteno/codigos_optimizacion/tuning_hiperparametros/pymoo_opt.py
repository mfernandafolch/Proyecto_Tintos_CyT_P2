"""
pymoo_opt.py
Implementación de optimización de hiperparámetros usando PSO con la biblioteca pymoo.

Consideraciones de diseño:
- Se define un problema personalizado de pymoo que encapsula la función objetivo basada en la simulación de fermentaciones.
- Se implementa un criterio de terminación personalizado basado en la relación entre el costo promedio y
 el costo mínimo en la población, con un umbral configurable.
- Se permite configurar los parámetros del PSO a través de un diccionario de configuración. 
- Se incluye manejo de errores robusto en la función objetivo para evitar que simulaciones fallidas 
afecten el proceso de optimización.
- Se proporciona una función para visualizar la historia de convergencia del PSO después de la optimización.
