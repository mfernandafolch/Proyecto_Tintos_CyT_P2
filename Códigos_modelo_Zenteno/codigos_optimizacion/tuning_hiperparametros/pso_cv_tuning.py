"""
pso_cv_tuning.py
Funciones para realizar la búsqueda de hiperparámetros del PSO utilizando validación cruzada.

El proceso general es el siguiente:
1. Se construyen los datasets a partir de las rutas proporcionadas.
2. Se generan los folds de validación cruzada (n_folds = n_datasets).
3. Se construye la grilla de combinaciones de hiperparámetros a evaluar.
4. Para cada combinación de hiperparámetros, se evalúa su desempeño en cada fold:
   a. Se entrena el modelo PSO con los datasets de entrenamiento del fold.
   b. Se evalúa el costo en el dataset de validación del fold.
5. Se guardan los resultados detallados de cada fold y un resumen por combinación de hiperparámetros en archivos Excel.
6. Se guarda un resumen del mejor resultado encontrado en un archivo JSON.
"""
