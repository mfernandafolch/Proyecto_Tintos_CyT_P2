...
Este script es el punto de entrada para el procesamiento de datos y la simulación del sistema.
Se encarga de:
1. Procesar los datos de los archivos Excel utilizando la función `process_excel`.
2. Simular el sistema utilizando la función `simulate_system_from_path` con los parámetros 
obtenidos en una estimación preliminar.
3. Graficar los resultados de la simulación junto con los datos observados utilizando las
funciones `plot_simulation` y `plot_simulation_with_data`.
